...
export const signup = async (email: string, password: string, role: 'user' | 'admin' | 'superuser' = 'user'): Promise<UserResponse> => {
...
export const signIn = async (email: string, password: string): Promise<UserResponse> => {
...
export const createSuperUser = async (email: string, password: string, secretKey: string): Promise<UserResponse> => {
